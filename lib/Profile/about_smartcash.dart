...
class AboutSamrtCashPage extends StatefulWidget {
  final String desc;
  const AboutSamrtCashPage({Key? key, required this.desc}) : super(key: key);
  @override
  State<AboutSamrtCashPage> createState() => _AboutSamrtCashPageState();
}

class _AboutSamrtCashPageState extends State<AboutSamrtCashPage> {
  @override
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text("About SamrtCash",style: TextStyle(
                    color: Colors.black,
                    fontSize: 16,
